    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <button type="submit" style="float:right" name="submit" value="download" class="btn btn-primary">Download</button>
                </div>
                @if(session('success'))
...
@endif
 ...
 showing  {{ $data->lastItem() }} of total {{ $data->total() }}  <a href="{{url('AdminListDisplay')}}" class="btn btn-primary">View All</a>
               </div>
            </div>
        </div>
    </div>
