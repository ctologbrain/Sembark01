        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                  ...
                  <button type="submit" style="float:right;margin-left: 3px;" class="btn btn-default" name="submit" value="download">Download</button> 
                  <a href="{{url('genrateUrls')}}" style="float:right" class="btn btn-default">  Generate  </a> 
...
@endif
    ...
    @php
      ...
      <tr>
        <td>{{$i}}</td>
        <td><a href="javascript:void(0)" onclick="hiturl('{{$value->id}}','{{$value->url}}')" title="Click here to visit {{$value->url}}" style="color:blue">{{$value->url}}</a></td>
